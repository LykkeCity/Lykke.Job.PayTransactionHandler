...
namespace Lykke.Job.PayTransactionHandler
{
    public class Startup
    {
        ...
        private static ILog CreateLogWithSlack(IServiceCollection services, IReloadingManager<AppSettings> settings)
        {
            ...
            var dbLogConnectionStringManager = settings.Nested(x => x.PayTransactionHandlerJob.Db.LogsConnString);
            ...
            var persistenceManager = new LykkeLogToAzureStoragePersistenceManager(
                AzureTableStorage<LogEntity>.Create(dbLogConnectionStringManager, "PayTransactionHandlerLog", consoleLogger),
                consoleLogger);
